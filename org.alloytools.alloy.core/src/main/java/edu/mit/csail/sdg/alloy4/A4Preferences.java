...
public class A4Preferences {
    ...
    public static final BooleanPref AStrykerTestGenerationARepairIntegrationNoUnnecessaryExpectInstanceWhenNoFacts = new BooleanPref("AStrykerTestGenerationARepairIntegrationNoUnnecessaryExpectInstanceWhenNoFacts", "BeAFix (Test Generation) | ARepair integration no instance test if no facts", false);
    public static final StringChoicePref AStrykerTestGenerationARepairIntegrationInstanceTestsBranches = new StringChoicePref("AStrykerTestGenerationARepairIntegrationInstanceTestsBranches", "BeAFix (Test Generation) | ARepair integration instance tests branches", Arrays.asList("BOTH", "POS", "NEG"), "BOTH");
